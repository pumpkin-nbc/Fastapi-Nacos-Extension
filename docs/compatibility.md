...
`>=0.112.2,<1.0.0`, and `nacos-sdk-python>=2.0.0,<3.0.0`. FastAPI's own
...
- Python 3.10 with FastAPI 0.129.0 and 0.141.1.
- Python 3.11, 3.12, 3.13 and 3.14 with FastAPI 0.141.1.
